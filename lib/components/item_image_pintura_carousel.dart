...
class ItemImageBannerMobile extends StatefulWidget {
  String imageURL;
  //bool themeDark;

  //ItemPromocionBannerMobiele(this.imageURL, {this.themeDark = false});
  ItemImageBannerMobile(this.imageURL, {super.key});
...
class _ItemPromocionBannerMobileState extends State<ItemImageBannerMobile> {
  @override
